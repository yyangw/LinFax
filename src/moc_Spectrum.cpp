/****************************************************************************
** Meta object code from reading C++ file 'Spectrum.hpp'
**
...
#error "The header file 'Spectrum.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_Spectrum[] = {
    "Spectrum\0\0buffer,n\0samples(int*,int)\0"
};
...
void Spectrum::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->samples((*reinterpret_cast< int*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
