/****************************************************************************
** Meta object code from reading C++ file 'OptionsDialog.hpp'
**
...
#error "The header file 'OptionsDialog.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_OptionsDialog[] = {
    "OptionsDialog\0\0okClicked()\0cancelClicked()\0"
};
